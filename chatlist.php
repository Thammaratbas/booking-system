...
<body>
    ...
    <div class="container mt-5">
        <h2>Chat List</h2>
        <a href="admin.php" class="btn btn-secondary mb-3">Back to Admin Page</a>
        <table class="table">
            <thead>
                <tr>
                    <th>Email</th>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php
                                ...
                                $unreadMessages = $database->countUnreadMessagesAdmin($_SESSION['userId'], $user['id']);
                        ...
                        <td>
                            <a href="chat.php?user_id=<?= $user['id'] ?>" class="btn btn-primary" onclick="markAsRead(<?= $_SESSION['userId'] ?>, <?= $user['id'] ?>);">Chat</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
    ...
    <script>
        ...
        function markAsRead(receiverId, senderId) {
            ...
            xhttp.open("GET", "mark_as_read_admin.php?receiver_id=" + receiverId + "&sender_id=" + senderId, true);
            xhttp.send();
        }
