...
<nav class="navbar fixed-top">
  <div class="container-fluid">
    <a class="navbar-brand fw-bold" href="admin.php">ECS Booking</a>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
      ...
      <div class="offcanvas-body">
        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
          ...
          <br>
          <li class="nav-item">
            <a class="nav-link" href="admin.php">Booking</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="userlist.php">User</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="roomlist.php">Room</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="confirm_room_admin.php">Confirm Room</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="history_admin.php">History</a>
          </li>
          <br>
